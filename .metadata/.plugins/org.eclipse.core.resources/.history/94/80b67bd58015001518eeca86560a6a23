...
var dogBreeds = {
		"strongDogs": [
				theMastiff: {
					group:"Working dogs",
					height: "Generally 2 feet, 3 inches to 2 feet, 8 inches tall at the shoulder",
					weight: "Generally 130 to 220 pounds",
					feeding: "6 to 8 cups of high-quality dry food a day, divided into two meals",
					life: "6 to 10 years",
					origin: "England",
				...
				theDane: {
					group:"Working Dogs",
					height: "Generally 2 feet, 4 inches to 2 feet, 10 inches tall at the shoulder",
					weight: "Generally 100 to 200 pounds",
					feeding: "Adults: females, 6 to 8 cups; males 8 to 10 cups",
					life: "7 to 10 years",
					origin: "Have been found on Egyptian artifacts dating back to 3000 B.C. but have been known to be bred from the English Mastiff with German influence.",
				...
				TheSaint: {
					group:"Working Dogs",
					height: "Generally 2 feet, 2 inches to 2 feet, 6 inches tall at the shoulder",
					weight: "Generally 120 to 180 pounds",
					feeding: "5 to 6 cups of high-quality dry food a day, divided into two meals",
					life: "8 to 10 years",
					origin: "Switzerland",
				...
				theRott: {
					...
					feeding: "4 to 10 cups of high-quality dry food a day, divided into two meals",
					life: "8 to 11 years",
					origin: "Their ancestors marched to Germany with the Romans",
					...
					image: "Rottreiller.jpg"
				},
				{
				irishWolfhound: {
					group:"Hounds",
					height: "Generally 2 feet, 8 inches to 2 feet, 11 inches tall at the shoulder",
					weight: "Generally 115 to 180 pounds",
					feeding: "4 to 8 cups of high-quality dry food a day, divided into two meals.",
					life: "6 to 8 years",
					origin: "Ireland",
				...
				theBoerboel: {
					group:"Working Dogs",
					height: "Generally 2 feet to 2 feet and 4 inches tall at the shoulder",
					weight: "Generally 110 to 220 pounds",
					feeding: "You feed your Boerboel as much food as is need to keep them in the \“trim\” condition",
					life: "10 years",
					origin: "Africa",
				...
				theGreat: {
					...
					feeding: "4 to 6 cups of high-quality dry food a day, divided into two meals",
					life: "10 to 12 years",
					origin: "Originated in the Pyrenees Mountains, which form a natural border between France and Spain.",
				...
				thePitt: {
					...
					weight: "Generally 30 to 85 pounds",
					feeding: "1.5 to 2.5 cups of high-quality dry food a day, divided into two meals",
					life: "12 to 16 years",
					origin: "England",
					...
					image: "American-Pit-Bull-Terrier.jpg"
				},
				{
				theSwissy: {
					group:"Working Dogs",
					height: "Generally 1 foot, 11 inches to 2 feet, 4 inches tall at the shoulder",
					weight: "Generally 85 to 140 pounds",
					feeding: "4 to 5 cups of high-quality dry food a day, divided into two meals",
					life: "7 to 9 years",
					origin: "Switzerland",
				...
				theNewFL: {
					group:"Working Dogs",
					height: "Generally 2 feet, 1 inch to 2 feet, 5 inches tall at the shoulder",
					weight: "Generally 100 to 150 pounds",
					feeding: "4 to 5 cups of high-quality dry food a day, divided into two meals",
					life: "8 to 10 years",
					origin: "Newfoundland",
