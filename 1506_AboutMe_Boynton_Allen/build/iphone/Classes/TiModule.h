...
/**
 The base class for all k1506_AboutMe_Boynton_Allen modules
 */
...
/**
 k1506_AboutMe_Boynton_Allen Platform calls this method on startup.
 */
-(void)startup;

/**
 k1506_AboutMe_Boynton_Allen Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 k1506_AboutMe_Boynton_Allen Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 k1506_AboutMe_Boynton_Allen Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 k1506_AboutMe_Boynton_Allen Platform calls this method on resume.
 @param sender The sender of the event.
 */
