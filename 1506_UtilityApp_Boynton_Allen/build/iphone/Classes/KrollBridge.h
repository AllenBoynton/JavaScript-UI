...
@interface k1506_UtilityApp_Boynton_AllenObject : KrollCoverageObject {
#else
@interface k1506_UtilityApp_Boynton_AllenObject : KrollObject {
#endif
@private
...
extern NSString * k1506_UtilityApp_Boynton_Allen$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k1506_UtilityApp_Boynton_AllenObject *_k1506_utilityapp_boynton_allen;
    KrollObject* console;
	BOOL shutdown;
