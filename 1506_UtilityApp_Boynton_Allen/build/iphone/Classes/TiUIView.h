...
/**
 Base class for all k1506_UtilityApp_Boynton_Allen views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the k1506_UtilityApp_Boynton_Allen view hierarchy (such as wrapped iOS UIViews) was touched.
