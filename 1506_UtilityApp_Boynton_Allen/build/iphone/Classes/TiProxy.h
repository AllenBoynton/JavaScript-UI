...
//Rare exceptions to indicate a bug in the _k1506_utilityapp_boynton_allen code (Eg, function that a subclass should have implemented)
...
/**
 The base class for k1506_UtilityApp_Boynton_Allen proxies.
 */
