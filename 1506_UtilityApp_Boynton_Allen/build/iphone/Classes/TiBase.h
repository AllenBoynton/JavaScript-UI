...
// in simulator we redefine to format for k1506_UtilityApp_Boynton_Allen Developer console
...
{\
	NSString * exceptionName = [@"org.k1506_utilityapp_boynton_allen." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k1506_utilityapp_boynton_allen";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk1506_UtilityApp_Boynton_AllenNativeItemNone = -1, 
	UIk1506_UtilityApp_Boynton_AllenNativeItemSpinner = -2,
	UIk1506_UtilityApp_Boynton_AllenNativeItemProgressBar = -3,
	
	UIk1506_UtilityApp_Boynton_AllenNativeItemSlider = -4,
	UIk1506_UtilityApp_Boynton_AllenNativeItemSwitch = -5,
	UIk1506_UtilityApp_Boynton_AllenNativeItemMultiButton = -6,
	UIk1506_UtilityApp_Boynton_AllenNativeItemSegmented = -7,
	
	UIk1506_UtilityApp_Boynton_AllenNativeItemTextView = -8,
	UIk1506_UtilityApp_Boynton_AllenNativeItemTextField = -9,
	UIk1506_UtilityApp_Boynton_AllenNativeItemSearchBar = -10,
	
	UIk1506_UtilityApp_Boynton_AllenNativeItemPicker = -11,
	UIk1506_UtilityApp_Boynton_AllenNativeItemDatePicker = -12,
	
	UIk1506_UtilityApp_Boynton_AllenNativeItemInfoLight = -13,
	UIk1506_UtilityApp_Boynton_AllenNativeItemInfoDark = -14,
	
	UIk1506_UtilityApp_Boynton_AllenNativeItemDisclosure = -15,
	
	UIk1506_UtilityApp_Boynton_AllenNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all k1506_UtilityApp_Boynton_Allen instances of
