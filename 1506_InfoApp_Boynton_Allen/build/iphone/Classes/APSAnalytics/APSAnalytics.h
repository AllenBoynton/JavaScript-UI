 ...
 * to send analytic data that can be viewed on the k1506_InfoApp_Boynton_Allen Dashboard.
 *
 * For information on getting started with k1506_InfoApp_Boynton_Allen Platform Services,
