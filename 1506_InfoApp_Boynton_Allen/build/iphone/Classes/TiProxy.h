...
//Rare exceptions to indicate a bug in the _k1506_infoapp_boynton_allen code (Eg, function that a subclass should have implemented)
...
/**
 The base class for k1506_InfoApp_Boynton_Allen proxies.
 */
