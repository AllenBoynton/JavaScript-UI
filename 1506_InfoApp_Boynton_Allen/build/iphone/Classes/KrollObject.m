...
//@interface k1506_InfoApp_Boynton_AllenObject : NSObject
//@end

@interface k1506_InfoApp_Boynton_AllenObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k1506_InfoApp_Boynton_AllenObject class]])
		{
			for (NSString *key in [[(k1506_InfoApp_Boynton_AllenObject*)o modules] allKeys])
			{
